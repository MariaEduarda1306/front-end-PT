...
const NGROK_API_URL = 'https://panoramic-figure-mushroom.ngrok-free.dev';
...
if (
    !savedApiUrl ||
    savedApiUrl.includes('localhost:8000') ||
    savedApiUrl.includes('127.0.0.1:8000') ||
    savedApiUrl.startsWith('http://panoramic-figure-mushroom')
) {
    savedApiUrl = NGROK_API_URL;
    localStorage.setItem('API_BASE_URL', savedApiUrl);
}
